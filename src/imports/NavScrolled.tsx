import svgPaths from "./svg-9glkvot68k";
...
function PrimaryRIbbon() {
  return (
    <div className="bg-[#083544] relative rounded-[12px] shadow-[0px_6px_15px_0px_rgba(16,24,40,0.08),0px_6px_15px_0px_rgba(16,24,40,0.08)] shrink-0 w-full" data-name=".Primary RIbbon">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[104px] py-[10px] relative size-full">
          <RibbonDetails />
        </div>
      </div>
    </div>
...
function Menu() {
  return (
    <div className="bg-white relative rounded-[12px] shrink-0 w-full" data-name="Menu">
      <div aria-hidden="true" className="absolute border-[#e5e7eb] border-[1.5px] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <div className="flex flex-row items-center size-full">
...
export default function NavScrolled() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative size-full" data-name="Nav Scrolled">
      <PrimaryRIbbon />
      <Frame2 />
    </div>
  );
