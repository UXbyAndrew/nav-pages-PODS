import svgPaths from "./svg-nd2ckgq2vh";
...
export default function NavAtTop() {
  return (
    <div className="content-stretch flex flex-col items-start relative size-full" data-name="Nav at Top">
      <PrimaryRIbbon />
      <Frame2 />
    </div>
  );
